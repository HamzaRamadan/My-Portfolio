export const myProjects = [
  {
    projectTitle: "Real-Estate-Map ",
    subTitle: "This project by React and TypeScript and Vite. It is a real estate mapping system. An interactive web application for managing and displaying land parcels using ArcGIS maps. and you can Add and Edit and Update Locations and filter by region and display result in table under the Map and you can add Draw Parcel and delet this parel if you want",
    category: ["react"],
    imgPath: "./images/Real-Estate-Map.png",
    linkWebSite: "https://real-estate-map-task-2.vercel.app/",
    GitHub: "https://github.com/HamzaRamadan/Real-Estate-Map-Task2"
